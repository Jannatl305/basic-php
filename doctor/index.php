<?php include 'config.php'; 
        ...
        $sql = "SELECT dm.*, availability.availability AS availability FROM dm JOIN availability ON dm.availability = availability.id WHERE status != '0'";
  ...
  <div class="container mt-5">
    <div class="d-flex justify-content-between mb-3">
        ...
        <div>
            ...
            <a href="trash.php" class="btn btn-danger">👩🏻‍🔬 See Trashed Doctor</a>
        </div>
    </div>
    ...
    <table class="table align-middle table-hover">
      ...
      <tbody>
        ...
        if (count($data) > 0) {
          ...
          <td>
            <a href="view.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning me-1">View</a>
